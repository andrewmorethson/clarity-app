...
export default function Dashboard() {
  ...
  // Expor globalmente para sub-componentes
  if (typeof window !== "undefined") { (window as any).connectTikTok = connectTikTok }
  ...
  return (
    <div>
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'14px' }}>
        ...
        <button className="btn-primary" onClick={() => (window as any).connectTikTok?.()}>+ Adicionar conta</button>
      </div>
      ...
      <div className="grid-2" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'20px' }}>
        <div>
          ...
          <div className="card">
            ...
            <button className="btn-outline" style={{ width:'100%', padding:'10px', marginTop:'4px' }} onClick={() => (window as any).connectTikTok?.()}>+ Adicionar conta</button>
          </div>
        </div>
        <div>
          <div className="card" style={{ marginBottom:'16px' }}>
